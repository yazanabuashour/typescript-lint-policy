...
for (const [file, bytes] of Object.entries(files)) {
  const destination = new URL(
    `../src/vendor/anti-slop/${file}`,
    import.meta.url,
  )

  NodeFS.mkdirSync(NodePath.dirname(NodeURL.fileURLToPath(destination)), {
    recursive: true,
  })
...
NodeFS.writeFileSync(
  new URL("../LICENSE.eslint-stylistic", import.meta.url),
  files["src/vendor/eslint-stylistic/LICENSE"],
)
