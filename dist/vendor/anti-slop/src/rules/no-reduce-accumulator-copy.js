...
import { arrayMethodTarget, isKnownArrayExpression, resolveArrayBinding, unwrapArrayExpression, } from "../shared/array-method.js";
function enclosingReducer(node) {
    ...
    while (parent !== null) {
        ...
        if (parent.type === "ArrowFunctionExpression" || parent.type === "FunctionExpression") {
            ...
            if (method === null || (method.name !== "reduce" && method.name !== "reduceRight") ||
